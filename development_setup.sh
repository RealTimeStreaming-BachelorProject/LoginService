...
docker run -d --name devdatabaseloginservice --restart=always -p 5432:5432 -e POSTGRES_USER=loginservice -e POSTGRES_PASSWORD=Loginservice_database_password1 -e POSTGRES_DB=loginservice-database postgres
